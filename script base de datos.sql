...
GO
    ...
    SELECT * FROM Hilos.CLIENTE;
    SELECT * FROM Hilos.FACTURA;
    SELECT * FROM Hilos.DETALLEFACTURA;

SELECT * FROM Hilos.CLIENTE cli
INNER JOIN Hilos.FACTURA fact on cli.ID = fact.IDCLIENTE
INNER JOIN Hilos.DETALLEFACTURA det ON fact.ID = det.IDFACTURA